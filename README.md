...
তালিকা রূপে, slice এবং splice মেথডের মধ্যে কিছু মূল পার্থক্যগুলি নিম্নে দেওয়া হল:
 ...
 | Slice                                        | Splice                                          |
   | -------------------------------------------- | ----------------------------------------------- |
|অরিজিনাল অ্যারে |	অস্পষ্ট করে না (মৌলিক অ্যারে পরিবর্তন হয় না)	| পরিবর্তন হয় (মৌলিক অ্যারে পরিবর্তন হয়)| ফলাফল |	অ্যারের একটি সাবসেট তৈরি করে |	মুছে ফেলা উপাদানগুলি রিটার্ন করে |
উদ্দেশ্য |	অ্যারে থেকে উপাদান নেওয়া |	অ্যারেতে উপাদান যোগ বা মুছে ফেলা |
